				...
				<srv:SV_ServiceIdentification>
					...
					<gmd:abstract>
						<xsl:choose>
							...
							<xsl:otherwise>
								<gco:CharacterString>OGC CSW service, this metadata harvested
			...
			<xsl:attribute name="codeListValue"><xsl:value-of select="./ows:Type"/></xsl:attribute>
					...
					<srv:serviceType>
						<!-- Valid values for OGC services would be then {<WMS, WFS, WVS, CSW, 
							…} -->
						<gco:LocalName codeSpace="http://resources.usgin.org/uri-gin/usgin/vocabulary/serviceType">CSW</gco:LocalName>
					</srv:serviceType>
				...
				<gmd:DQ_Scope>
                    ...
                    <gmd:lineage>
                        <gmd:LI_Lineage>
                            <gmd:statement>
                                <gco:CharacterString>
                                    <xsl:value-of select="concat('This metadata record harvested from ', $sourceUrl, '. and transformed to USGIN ISO19139 profile using ogcCSW-toUSGIN_ISO19139.xslt version 1.0')"/>
                                </gco:CharacterString>
                        </gmd:statement>
                        </gmd:LI_Lineage>
                    </gmd:lineage>
