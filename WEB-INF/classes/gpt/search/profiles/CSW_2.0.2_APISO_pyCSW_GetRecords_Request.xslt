...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
			...
			<csw:Query typeNames="gmd:MD_Metadata">
				...
				<csw:Constraint version="1.1.0">
					...
					<ogc:Filter xmlns="http://www.opengis.net/ogc">	
						<xsl:choose>
							<xsl:when test="count(/GetRecords/KeyWord) &gt; 1">
                  ...
                  <!-- Date Range Search -->
							...
							<!-- If KeyWord Fails, pass apiso:Title Query Filter and Constraints are required -->
								<xsl:otherwise>
  ...
  <!-- date search -->
	...
	<!--output keywords for Anytext /KeyWord template -->
